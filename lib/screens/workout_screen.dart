...
class WorkoutDetailScreen extends StatelessWidget {
  const WorkoutDetailScreen({Key? key, required String workoutType, required String title, required String duration, required String calories, required String imageUrl}) : super(key: key);
